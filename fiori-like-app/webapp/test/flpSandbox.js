		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "webapp",
									"targetURL": "#fiorilikeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorilikeapp-display": {
								"semanticObject": "fiorilikeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorilikeapp",
									"url": sap.ui.require.toUrl("fiorilikeapp")
								}
							}
						}
					}
